 ...
 * Generated at: 2022-11-22 01:37:50 UTC
...
public final class chart01Multi_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("$(function() {\r\n");
      out.write("	//구글 차트 라이브러리 로딩(메모리에 올린다)\r\n");
      out.write("	google.load(\"visualization\",\"1\",{\r\n");
      out.write("		\"packages\":[\"corechart\"]\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
      out.write("	//로딩이 완료되면 drawChart 함수를 호출하자\r\n");
      ...
      out.write("	//responseText : json 데이터를 텍스트로 읽어온다. console.log로 볼 수 있다\r\n");
      out.write("	function drawChart() {\r\n");
      out.write("		let jsonData = $.ajax({\r\n");
      out.write("			url:\"/resources/json/sampleData.json\",\r\n");
      ...
      out.write("		let data = new google.visualization.DataTable(jsonData);\r\n");
      out.write("		//차트를 출력할 div 선택(PieChart, LineChart, ColumnChart)\r\n");
      out.write("		let chart = new google.visualization.LineChart(document.getElementById(\"chart_div3\"));\r\n");
      out.write("		//차트객체(chart).draw(데이터테이블(data), 옵션)\r\n");
      out.write("		chart.draw(data,{\r\n");
